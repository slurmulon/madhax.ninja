...
export const all = [
  ...
  { id: 'svg', title: 'SVG', url: 'https://www.w3.org/Graphics/SVG/', icon: 'svg.png', level: 80 },
  ...
  { id: 'phoenix', title: 'Phoenix', url: 'http://phoenixframework.org', icon: 'phoenix.png', level: 70 },
  ...
  { id: 'mapbox', title: 'Mapbox', url: 'https://mapbox.com', icon: 'mapbox.png', level: 75 },
