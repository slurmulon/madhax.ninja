<template>
  <a :href="tool.url" target="tool">
    <img :src="require(`@/assets/img/${tool.icon}`)" :class="{ 'shiny-icon': shiny }" :style="{ 'width': width }" />
  </a>
</template>

<script>
export default {
  props: ['id', 'shiny', 'width']
  data: () => ({
    all: [
      { id: 'js', title: 'JavaScript', url: 'https://nodejs.org', icon: 'js.png', level: 95 },
      { id: 'html5', title: 'HTML5', url: 'https://www.w3.org/TR/html52/', icon: 'html5.png', level: 80 },
      { id: 'css3', title: 'CSS3', url: 'http://css-tricks.com', icon: 'css3.png', level: 75 },
      { id: 'elixir', title: 'Elixir', url: 'https://elixir-lang.org', icon: 'elixir.png', level: 50 },
      { id: 'clojure', title: 'Clojure', url: 'https://clojure.org', icon: 'clojure.png', level: 50 },
      ...
      { id: 'phoenix', title: 'Phoenix', url: 'http://phoenixframework.org', icon: 'phoenix.png', level: 50 },
      { id: 'django', title: 'Django', url: 'https://djangoproject.com', icon: 'django.png', level: 75 },
      ...
      { id: 'api-blueprint', title: 'API Blueprint', url: 'https://apiblueprint.org', icon: 'api-blueprint.png', level: 90 },
